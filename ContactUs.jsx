...
export default function ContactUs(props) {
  ...
  const vectorTwoNineSevenSixSixNineFourFourOnClick = useNavigateAction({
    type: "url",
  ...
  const vectorTwoNineSevenSixSixNineFourEightOnClick = useNavigateAction({
    type: "url",
        ...
        >
          ...
          >
            <Icon
              ...
              right="8.33%"
              onClick={() => {
                vectorTwoNineSevenSixSixNineFourFourOnClick();
              }}
        ...
        >
          ...
          >
            <Icon
              ...
              right="16.67%"
              onClick={() => {
                vectorTwoNineSevenSixSixNineFourEightOnClick();
              }}
